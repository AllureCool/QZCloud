...
@Entity(tableName = "TableDownloadFile")
data class Direcotory(
        @PrimaryKey
        @NotNull
        val identity: String, //该文件/文件夹的唯一ID
        val userIdentity: Int, //用户id
...
//        val recycle: Int, //0:正常文件，1:回收站
        ...
        var downloadStatus: Int = 0, //0: 未下载 1：正在下载 2：暂停 3：下载失败 4：下载完成 5:队列中 6:文件损坏重新下载
